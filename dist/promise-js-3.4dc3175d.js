...
})({"zeqxf":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "3a6fa1e04dc3175d";
"use strict";
...
},{}],"27jWi":[function(require,module,exports,__globalThis) {
//                       pnotify
...
input.addEventListener('input', _.debounce(function() {
    ...
    if (input.value == " " || input.value == undefined) PNotify.alert({
        text: 'Print name of country!'
    });
    else fetch('https://restcountries.com/v2/name/' + input.value).then((response)=>{
...
},{}],"grIyt":[function() {},{}]},["zeqxf","27jWi"], "27jWi", "parcelRequire1510", {})

//# sourceMappingURL=promise-js-3.4dc3175d.js.map
